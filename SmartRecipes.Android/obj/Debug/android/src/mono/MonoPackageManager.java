...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "SmartRecipes.Android.dll" comes first in this list. */
		"SmartRecipes.Android.dll",
		"Fabulous.Core.dll",
		"Fabulous.CustomControls.dll",
		"Fabulous.LiveUpdate.dll",
		"FormsViewGroup.dll",
		"FSharp.Core.dll",
		"Newtonsoft.Json.dll",
		"SmartRecipes.dll",
		...
		"Xamarin.Android.FSharp.ResourceProvider.Runtime.dll",
