...
module Elements =
    ...
    let headingFontSize = FontSize.fromValue 24.0
    ...
    type Elements() =
        ...
        static member RefreshListPageContent(isLoading, items, itemView, onTapped, refresh, emptyText, rowHeight) =
            ...
            View.Grid(
                ...
                rowdefs = [Dimension.Star],
                rowSpacing = 0.0,
                children = [
                    yield Elements.List(items, itemView, onTapped, refresh, rowHeight).Row(0)
